...
class device_TK:
    ...
    def __init__(self,parent,name,GPIO,port,testmode=0):
        ...
        self.label = tk.Label(self.frame,justify='left',anchor='center',text=self.device.name + ':',width=20)
        self.button = tk.Button(self.frame,text='OFF',fg='white',bg='red',command=self.switch,width=10)
